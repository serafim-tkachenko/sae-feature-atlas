...
def build_run_manifest(cfg: ExperimentConfig, metrics: dict, stage: str) -> dict:
    ...
    return {
        ...
        "artifacts": {
            ...
            "inspection_feature_summaries": str(cfg.inspection_feature_summaries_path),
            "inspection_pair_summaries": str(cfg.inspection_pair_summaries_path),
            "inspection_report_md": str(cfg.inspection_report_md_path),
            "inspection_report_json": str(cfg.inspection_report_json_path),
            "residual_pca_summary": str(cfg.residual_pca_summary_path),
            "decoder_pca_summary": str(cfg.decoder_pca_summary_path),
            "decoder_feature_pca": str(cfg.decoder_feature_pca_path),
            "decoder_feature_umap": str(cfg.decoder_feature_umap_path),
            "decoder_residual_pc_alignment": str(cfg.decoder_residual_pc_alignment_path),
            "graph_alignment": str(cfg.graph_alignment_path),
            "graph_alignment_summary": str(cfg.graph_alignment_summary_path),
